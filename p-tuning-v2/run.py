...
def train(trainer, resume_from_checkpoint=None, last_checkpoint=None, training_args=None):
    checkpoint = None
    ...
    # trainer.save_model()
    # state_dict=trainer.model.prefix_encoder.state_dict()
    # torch.save(state_dict,training_args.output_dir+'/prefix_encoder.bin')
...
if __name__ == '__main__':
    ...
    if training_args.do_train:
        train(trainer, training_args.resume_from_checkpoint, last_checkpoint, training_args)
