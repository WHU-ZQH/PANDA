...
class ModelArguments:
    ...
    source_prompt: Optional[str] = field(
        default=None,
        metadata={"help": "the path of pretraining source prompt"},
    )
    target_prompt: Optional[str] = field(
        default=None,
        metadata={"help": "the path of pretraining source prompt"},
    )
    ...
    prompt_transfer: int = field(
        default=0,
        metadata={
            "help": "0: no transfer, 1: vanilla transfer, 2: our transfer method"
        }
    )
    prompt: bool = field(
        default=False,
