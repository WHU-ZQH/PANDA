...
class BertForMultipleChoice(BertPreTrainedModel):
    ...
    def forward(
        ...
        # name=""
        # if self.config.name_or_path=='bert-base-cased':
        #     name="bert-base"
        # elif "small" in self.config.name_or_path:
        #     name="bert-small"
        # elif "medium" in self.config.name_or_path:
        #     name="bert-medium"
        # elif "tiny" in self.config.name_or_path:
        #     name="bert-tiny"

        # torch.save(outputs, 
        # "p-tuning-v2/{}_similarity/model_tuning/{}_eval.pt".format(name,self.config.finetuning_task))
        # assert 0
...
class BertPrefixForMultipleChoice(BertPreTrainedModel):
    ...
    def forward(
        ...
        # torch.save(outputs, 
        # "p-tuning-v2/{}_similarity/model_tuning/{}_eval_all_train.pt".format(name,self.config.finetuning_task))
        # assert 0
        pooled_output = outputs[1]
